...
public class FileTask2 {
	public static void main(String[] args) throws IOException{
		...
		Users user1 = new Users(1L, "홍길동", 20, "판사");
		Users user2 = new Users(1L, "김철수", 20, "코딩");
		Users user3 = new Users(1L, "김영희", 20, "교사");
		Users user4 = new Users(1L, "신짱구", 20, "유치원생");
		Users user5 = new Users(1L, "흰둥이", 20, "개");
